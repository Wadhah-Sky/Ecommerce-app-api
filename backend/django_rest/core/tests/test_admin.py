...
#
#     # IMPORTANT: we disabled this test class because the issue with accessing
#     #            /usr/... in ubuntu system while trying to do GitHub
#     #            actions test, that will show you permission denied.
#
#     def setUp(self):
...
#
#         # Note: 'change' page of django admin using HTTP POST method not
#         #       PATCH or PUT.
#
#         url = reverse('admin:core_category_add')
#
#         # Using context manager create temporary file with '.txt' extension
#         # and able to write + read.
