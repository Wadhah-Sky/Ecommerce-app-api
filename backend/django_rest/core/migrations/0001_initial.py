# Generated by Django 4.0.8 on 2023-03-06 02:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_class', models.CharField(choices=[('option-checkbox', 'option-checkbox'), ('option-btn', 'option-btn'), ('option-color', 'option-color')], default='check-input', max_length=20)),
                ('display_order', models.PositiveSmallIntegerField(blank=True, null=True)),
                ('is_item_option', models.BooleanField(default=True, help_text='By selecting this option as True, means this attribute option will not show within the Product Attribute model suggestions for attribute_option field')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField()),
                ('updated_at', models.DateTimeField()),
                ('title', models.CharField(help_text='Can be use as coupon code', max_length=25, unique=True)),
