# Generated by Django 4.0.10 on 2024-01-28 12:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_url', models.URLField(blank=True, help_text='Set URL for icon SVG source', max_length=255)),
                ('source2_url', models.URLField(blank=True, help_text='Set URL for icon image source e.g. PNG or JPG', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Meta',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=100, unique=True)),
                ('thumbnail', imagekit.models.fields.ProcessedImageField(blank=True, upload_to=core.models.create_file_path)),
                ('file', models.FileField(blank=True, upload_to=core.models.create_file_path)),
                ('value', models.CharField(blank=True, max_length=255)),
                ('source_url', models.URLField(blank=True, help_text='You can set URL for icon SVG source', max_length=255)),
                ('source2_url', models.URLField(blank=True, help_text='You can set URL for icon image source e.g. PNG or JPG', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('use_default_images', models.BooleanField(default=False, help_text='With selecting, the default product item images will be use even if the current product item has images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_target', models.CharField(choices=[('_self', '_self'), ('_blank', '_blank'), ('_parent', '_parent'), ('_top', '_top')], default='_blank', max_length=7)),
