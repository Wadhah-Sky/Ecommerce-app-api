  ...
  <div class="container">
    <div class="content">
      ...
      <div class="card">
        ...
        <div v-if="![null, undefined, ''].includes(storeCheckout.orderAPIPOCode) && [null, undefined, ''].includes(storeCheckout.orderApiErrorMsg)">

          <div class="d-flex justify-content-center align-items-center"
               style="margin-top: 30px; margin-bottom: 60px; padding: 18px 13px">
            <div>
              ...
              <div class="text-center">
                ...
                <p>
                  <span style="display: block">We've got your order!</span>
                  <span style="display: block">We'll drop you email with the order details.</span>
                  <br>
                  <span style="display: block; font-weight: 500">ORDER No.</span>
                  <span style="font-weight: 600">{{storeCheckout.orderAPIPOCode}}</span>
                </p>

                <router-link :to="{name: 'home'}"
                             :class="['btn btn-home', storeCheckout.dataLoading ? 'disabled' : '']"
                >
                  <span>
                    <font-awesome-icon :icon="['fa-solid', 'fa-house']" style="margin-right: 3px"/>
                    Back Home
                  </span>
        ...
        <div v-else class="row">
          ...
          <div :class="[storeCheckout.itemsCount > 0 ? 'col-md-8' : 'col-md-12', 'cart']">
            ...
            <ul class="shopping-cart-items">
              ...
              <li v-else>
                <div class="row ms-0 me-0 pt-4 mb-5 text-center clearfix">
                  <div class="col align-self-center" style="font-size: 16px; font-weight: 500">Cart is empty</div>
                </div>
              </li>
