...
const shippingMethod = ref(storeCheckout.shippingDetails['shippingMethod'] || null);
...
const calculateShippingCost = async () => {
  ...
  let method = shippingMethod.value;
  ...
  if (![undefined, '', null].includes(method)) {
    ...
    let data = {
      ...
      "shipping_address": storeCheckout.shippingAddress
    };
...
const loadShippingDetails = async () =>{
  ...
  if(storeCheckout.isShippingInfoSet){
