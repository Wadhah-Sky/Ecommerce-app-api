...
# using exit in called script, it will exit the first (callee) script as well,
# alternatively you can use:
#
# /bin/bash /path/to/scrip
#
# another method, if you are using exit in called script, it will NOT exit the
# first script as well.
